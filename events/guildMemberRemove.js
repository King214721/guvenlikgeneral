    ...
    if(kickKoruması) {
        ...
        if (target.id === member.id) {
            ...
            if(userPoint >= l) {
                ...
                .setColor("#ED4245")
                .setDescription(`<:cs_warn2:1142138650314952795> **${executor.tag}** **yasaklandı.** (**${userPoint}**)`)
                ...
                const embed = new EmbedBuilder()
                .setColor("#FEE75C")
                .setDescription(`<:cs_warn2:1142138650314952795> **${executor.tag}** birini sunucudan attı, devam ederse onu banlayacağım! (${l}/**${userPoint}**)`)
