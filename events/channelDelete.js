    ...
    if(kanalKoruması) {
        ...
        if (executor) {
            ...
            if(userPoint >= l) {
                ...
                const embed = new EmbedBuilder()
                .setColor("#FEE75C")
                .setDescription(`<:cs_warn2:1142138650314952795> **${executor.tag}** bir kanal sildi, devam ederse onu banlayacağım! (${l}/**${userPoint}**)`)
            ...
            const embed = new EmbedBuilder()
                .setColor("#ED4245")
                .setDescription(`<:cs_warn2:1142138650314952795> **İllegal biri kanal sildi.**`)
